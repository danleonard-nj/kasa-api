from domain.rest import CreateSceneCategoryRequest, CreateSceneRequest, RunSceneRequest, UpdateSceneRequest
...
async def get_scenes(container):
    ...
    # result = await kasa_scene_service.get_all_scenes()
